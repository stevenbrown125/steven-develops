    ...
    return (
        <section >
            ...
            <div className='flex flex-col 2xl:flex-row'>
                <div className="space-y-4 2xl:max-w-2xl mt-6 2xl:mt-0 mx-10 2xl:mx-0 2xl:mr-6 dark:text-zinc-200 flex-1 order-2 2xl:order-1">
                ...
                <div className='w-full 2xl:w-[540px] order-1 2xl:order-2'>
                    <Figure figure={{ href: "/images/rome-optimized.jpg", alt: "Rome, Italy 2020", classes: '2xl:mt-6 opacity-80 relative z-10 vertical-hr pl-6' }} />
                </div>
            </div>
        </section>
    );
