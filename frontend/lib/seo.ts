...
export const generateTagListingSEOData = (
  tag: Tag,
...
export const generateCategoryListingSEOData = (
  category: Category,
  image: string = defaultImage,
): SEOData => {
...
export const generateTechnologyListingSEOData = (
