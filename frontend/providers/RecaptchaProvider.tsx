...
export const RecaptchaProvider = ({ children, siteKey, nonce }: RecaptchaProviderProps) => {
...
const loadReCAPTCHA = (siteKey: string, setIsRecaptchaLoaded: (value: boolean) => void, nonce: string) => {
